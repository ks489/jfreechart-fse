...
public class Pie implements IChart{
    ...
    public Pie(PieDataset dataset, PieDataset previousDataset,
	...
	public JFreeChart createChart(String title) {
        ...
        for (Comparable key : keys) {
            ...
            if (oldValue == null) {
                ...
                double shade
                        = (Math.abs(percentChange) >= _percentDiffForMaxScale ? 255
        ...
        if (_subTitle) {
            TextTitle subtitle;
            subtitle = new TextTitle("Bright " + (_greenForIncrease ? "red"
                    : "green") + "=change >=-" + _percentDiffForMaxScale
